    ...
    >
        ...
        {floaters.map(f => (
          <motion.span
            ...
            style={{
              ...
              color: '#22c55e', pointerEvents: 'none', zIndex: 99,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
          <motion.div
            animate={isActive && !isDone
              ? { boxShadow: ['0 0 0px rgba(244,197,66,0.3)','0 0 14px rgba(244,197,66,0.7)','0 0 0px rgba(244,197,66,0.3)'] }
              : {}}
      ...
      <div style={{
        ...
        {groups.map((group, gi) => (
          <React.Fragment key={gi}>
            ...
            {gi < 4 && (
              <span style={{ color: '#2d4a5e', fontSize: 'var(--fs-md)', fontWeight: 700, userSelect: 'none' }}>—</span>
            )}
          </React.Fragment>
        ))}
      </div>
      ...
      {isActive && !isDone && (
        <motion.p
          ...
          style={{
            marginTop: 12, fontSize: 'var(--fs-sm)',
            color: '#fbbf24',
            fontFamily: 'Hind Siliguri, sans-serif',
            lineHeight: 1.6,
          }}
