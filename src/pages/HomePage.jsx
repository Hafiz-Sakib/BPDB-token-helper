  ...
  return (
    ...
    >
      ...
      <motion.header
        ...
        style={{
          textAlign: "center",
          padding: "clamp(20px,4vw,48px) 0 clamp(20px,4vw,32px)",
        }}
      >
        {/* VisitorCounter — handles its own positioning:
            mobile → inline centered here, desktop → fixed top-right portal */}
        <VisitorCounter />
