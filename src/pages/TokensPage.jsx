...
export default function TokensPage() {
  ...
  const handleMarkDone = (idx) => {
    ...
    if (next.size === tokens.length) {
      toast.success("সব টোকেন দেওয়া হয়েছে! 🎉", { duration: 2500 });
    ...
    <div style={{
      ...
      <motion.button
        ...
        style={{
          ...
          color: "#94a3b8", fontSize: "var(--fs-sm)", cursor: "pointer",
          fontFamily: "Hind Siliguri, sans-serif", marginBottom: 22,
        }}
      >
